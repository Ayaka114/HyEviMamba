...
def main():
    ...
    train_dataset = datasets.ImageFolder(root="/home1/zhouhao/MedMamba_ywj/datasets/RetinalOCT-C8/RetinalOCT_Dataset/RetinalOCT_Dataset/train",
    ...
    validate_dataset = datasets.ImageFolder(root="/home1/zhouhao/MedMamba_ywj/datasets/RetinalOCT-C8/RetinalOCT_Dataset/RetinalOCT_Dataset/test",
