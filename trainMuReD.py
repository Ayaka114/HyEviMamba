...
def main():
    ...
    train_dataset = datasets.ImageFolder(root="/home1/zhouhao/MedMamba_ywj/datasets/MuReD/Multi-Label Retinal Diseases (MuReD) Dataset/Training",
    ...
    validate_dataset = datasets.ImageFolder(root="/home1/zhouhao/MedMamba_ywj/datasets/MuReD/Multi-Label Retinal Diseases (MuReD) Dataset/Test",
