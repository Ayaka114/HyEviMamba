...
#
#CUDA_VISIBLE_DEVICES=0 python medmnist_train.py --batch-size 128 --epochs 150 \
#--hyper-ad 0 --reduction-ratio 4 \
#--EDL 0 --kl-coef 5e-3 \
#--save-name retinamnist_ 2>&1 | tee ./logs/retinamnist_.log
#
#CUDA_VISIBLE_DEVICES=3 python medmnist_train.py --batch-size 128 --epochs 150 \
#--hyper-ad 1 --reduction-ratio 4 \
#--EDL 1 --kl-coef 5e-3 \
#--save-name octmnist_224_1 2>&1 | tee ./logs/octmnist_224_1.log
